...
namespace Juntas_MC.PL
{
    public partial class Listados : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (txtAumento.Text == "1") { this.dgvListado.Columns["PrecioDeVenta"].Visible = false; }
        ...
        private void cbMarca_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else { cmbMarca.Enabled = false; cmbMarca.SelectedItem = null; llenadoComboBoxModelos(); }
        }
        ...
        private void cbModelo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else { cmbModelo.Enabled = false; cmbModelo.SelectedItem = null; }
        }
        ...
        public void imprimirListadoDGVPrinter()
        {
            ...
            printer.Footer = string.Format("Telefono: 1136579253"); /*lblImporteTotal.Text;*/
